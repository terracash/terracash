...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/terracash-project/terracash>";
    const std::string URL_WEBSITE = "<https://terracash.org>";
