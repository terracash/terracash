...
{
    const char* pszTimestamp = "BBC New 8/May/2018 South Korean Top Regulator Considers Easing Cryptocurrency Regulations";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1525768365, 2086046323, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x83515e13ce159c68da7b0a74dcdd5e842ef99544e393caaa667722494dce653c"));
        assert(genesis.hashMerkleRoot == uint256S("0x159801421d5a7e9275bd1cc880260c7a55da03b9186c9b0e20eb69f3dcf5b9fd"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.terracash.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.terracashtools.com", true);
        //vSeeds.emplace_back("dnsseed.terracashpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.terracashtools.com", true);
        vSeeds.emplace_back("seed-b.terracash.loshan.co.uk", true);
