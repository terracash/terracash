...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Terracash Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Terracash Core"
...
#define PACKAGE_BUGREPORT "https://github.com/terracash-project/terracash/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Terracash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Terracash Core 0.15.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "terracash"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://terracash.org/"
