...
const char * const BITCOIN_CONF_FILENAME = "terracash.conf";
const char * const BITCOIN_PID_FILENAME = "terracash.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Terracash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Terracash";
#else
    // Unix
    return pathRet / ".terracash";
#endif
#endif
}
